...
package vga_ref_pack is
	...
	constant ROM_DEPTH 			: integer := 19500;		-- The depth of picture ROM
	constant MESSAGE_START_H	: integer := 79;			-- Horizontal start position of the message
	constant MESSAGE_START_V	: integer := 179;			-- Vertical start position of the message
	constant MESSAGE_WIDTH 		: integer := 390;			-- Width of the message
	constant MESSAGE_HEIGHT 	: integer := 50;			-- Height of the message
